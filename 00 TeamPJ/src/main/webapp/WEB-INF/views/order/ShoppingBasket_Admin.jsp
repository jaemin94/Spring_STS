...
<link href="${pageContext.request.contextPath}/resources/static/css/Common_Admin.css" 
...
<link href="https://fonts.googleapis.com/css2?family=Chewy&display=swap"
 ...
 <!-- jQuery UI CSS 파일 -->
  ...
  <link href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css" rel="stylesheet" />
	  ...
	  <script src="${pageContext.request.contextPath}/resources/static/js/OrderTable.js"></script>
			...
			<div class="searchwrapper">
				<div class="midsearchwrapper">
					...
					<script type="text/javascript"
						src="${pageContext.request.contextPath}/resources/static/js/Order.js"></script>

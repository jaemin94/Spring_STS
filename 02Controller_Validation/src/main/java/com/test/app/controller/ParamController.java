...
//	@GetMapping("/param01")
	...
	@GetMapping("/param03")
	public void p3(@RequestParam(required = false,defaultValue = "남길동") String name) {
	...
	@GetMapping("/param07/{name}/{age}/{addr}")
	public String p7(Person person,Model model) {

...
public class OrderController {
	...
	@GetMapping(value = "/ShoppingBasket_Admin4" , produces = MediaType.APPLICATION_JSON_VALUE)
	public String getOrderToUpdateDelete4()
	{
		log.info("OrderController's getOrder");
		return "/order/ShoppingBasket_Admin4";
	}

...
<div class="wrapper">
    ...
    <section class="product_info_block">
      <div >
        <form  onsubmit="return false" name="productform" >
          ...
          <button  class="btn btn-primary add_product_btn">제품등록</button><br />
        </form>
      </div>
    </section>
  ...
  <footer>
	...
	<script>
		//******************************************************************
		const formData = new FormData(); // form 정보 저장	
		...
		uploadBox_el.addEventListener('drop',function(e){
			...
			//******************************************************************
			//form 데이터에 저장
			//dragdrop 파일들은 files란 이름으로 배열형식으로 저장되게 됨.
			formData.append('files',file);

		}); 

		const add_product_btn_el = document.querySelector('.add_product_btn'); //제품등록 버튼
		add_product_btn_el.addEventListener('click',function(){ //add_product_btn_el 누를 시 입력 된 code/name/type formData에 삽입
